...
export default function Home() {
  return (
    <>
      <div className="bg-[#f8f5ef] flex justify-center">
        <div className="inner-container max-w-[1920px]">
          ...
          <div
            className="hero-section-container relative w-full min-h-[1080px] flex flex-col md:flex-row"
            id="hero"
          >
            <div className="hero-text-container pt-40 md:pt-0 w-full md:w-3/5 flex flex-col justify-center z-[2] p-10 relative md:static md:ml-10">
              <h1 className="hero-heading text-5xl md:text-7xl font-extralight tracking-tight leading-tight">
                {'May 2024'.split('').map((letter, key) => (
                  <span className="fancy-hero-text" key={key}>
                    {letter}
                  </span>
                ))}
                <br />
                {'Art Challenge'.split('').map((letter, key) => (
                  <span className="fancy-hero-text" key={key}>
                    {letter}
                  </span>
                ))}
              ...
              <p className="hero-description leading-loose text-lg md:text-xl md:mt-5">
                I launched this competition as a tribute to the community that
                not only transformed my life but also saved it.
                <br />
                <br />
                ...
                <br />
                <br />
                Four exceptional artists enthusiastically took part, and I had
                the privilege of individually collaborating with each of them on
                their masterpieces. A cheeky £50 prize awaited the winner, to be
                chosen through an Instagram voting frenzy.
                <br />
                <br />
                Using the power of JavaScript, I meticulously collected and
                curated the comments, which you can now visually explore right
                here on this very site. Join me as we delve into each artwork
                and unveil the thrilling outcome of this artistic showdown.
              </p>
            </div>
      ...
      <div className="mx-auto">
        <div className="bg-pink-100 h-auto w-full pb-20 flex justify-center">
          <div className="inner-container max-w-[1920px]">
            <div className="artist-1-expo-container w-full flex flex-col lg:flex-row items-center justify-center">
              <div className="artist-1-text-container pt-20 lg:pt-0 w-full lg:w-2/5 flex flex-col p-10 lg:ml-10">
                ...
                <p className="artist-1-description leading-loose text-lg lg:text-xl lg:mt-5">
                  ...
                  recent disagreement. Reluctantly, I shrugged off the covers
                  and sluggishly waddled towards the window.
                  <br />
                  <br />
                  Pulling back the heavy curtains, I was met with a blinding
                  glare from the sun, my nocturnal self screeched faintly.
                  Blinking to adjust to its brilliance, amidst the overwhelming
                  light, there she stood, holding a bouquet of flowers. She knew
                  me all too well.
                  <br />
                  <br />
                  ...
                  pink jasmine palette. Meanwhile, Sean Donny adds a bold,
                  modern twist to the impressionistic scene, creating a
                  captivating fusion of styles and perspectives.
                </p>
              </div>
        ...
        <div className="bg-[#738af3] h-auto w-full pb-20 flex justify-center">
          <div className="inner-container max-w-[1920px]">
        ...
        <div className="bg-[#5a79eb] h-auto w-full pb-20 flex justify-center">
          <div className="inner-container max-w-[1920px]">
        ...
        <div className="bg-[#58a4c9] h-auto w-full pb-20 flex justify-center">
          <div className="inner-container max-w-[1920px]">
            <div className="artist-4-expo-container w-full flex flex-col-reverse lg:flex-row items-center justify-center">
              ...
              <div className="artist-4-text-container pt-20 lg:pt-0 w-full lg:w-3/5 flex flex-col p-10 lg:ml-10">
                ...
                <p className="artist-4-description leading-loose text-lg lg:text-xl lg:mt-5">
                  ...
                  &#34;Falling or Flying&#34; artist is depicted staring
                  directly at the viewer, confronting her various sides through
                  reflections.
                  <br />
                  <br />
                  ...
                  sandwiched between Jorja&#39;s multiple stares. A prolonged
                  gaze could lead one to feel lost, or worse, trapped in this
        ...
        <div className="bg-[#f8f5ef] h-auto w-full flex justify-center">
          <div className="inner-container max-w-[1920px]">
            <div className="voting-results-expo-container w-full flex flex-col lg:flex-row items-center justify-center pb-20">
              <div className="voting-results-text-container pt-20 lg:pt-0 w-full lg:w-2/5 flex flex-col p-10 lg:ml-10">
                ...
                <p className="voting-results-description leading-loose text-lg lg:text-xl lg:mt-5">
                  After a relentless two-day battle, where every artist
                  showcased exceptional brilliance and talent, the competition
                  took a dramatic turn as Vinco and Manny surged ahead in the
                  polls before the first day&#39;s dusk.
                  <br />
                  <br />
                  In a stunning display of support, Manny skyrocketed in votes,
                  securing a landslide victory against all odds. Despite
                  spirited efforts from Vinco&#39;s <b>168</b> supporters,
                  marked by multiple enthusiastic <b>1&#39;s</b> in the comment
                  section, Manny emerged triumphant in the ultimate showdown
                  with a staggering <b>374</b> votes.
                  <br />
                  <br />
        ...
        <div className="bg-[#050413] h-auto w-full pb-20 text-slate-200 flex justify-center">
          <div className="inner-container max-w-[1920px]">
            <div className="development-expo-container w-full flex flex-col-reverse lg:flex-row items-center justify-center">
              ...
              <div className="development-text-container pt-20 lg:pt-0 w-full lg:w-3/5 flex flex-col p-10 lg:ml-10">
                ...
                <p className="development-description leading-loose text-lg lg:text-xl lg:mt-5">
                  ...
                  JavaScript and Next.js. Check out my not-so-sketchy code on
                  ...
                  .<br />
                  <br />
                  If you do geek out and look at the code, please be kind—I am
                  not a mid-level front-end heavy web developer. The code works,
                  and that&#39;s what matters. I have to put my Software
                  Engineering degree to use somehow, right?
                </p>
              </div>
            </div>
          </div>
        </div>
        <div className="footer bg-[#050413] w-full h-12 flex justify-center">
          <div className="inner-container max-w-[1920px]">
            <div className="footer-inner flex flex-row items-center justify-center lg:justify-end">
              <div className="footer-links flex space-x-8 md:space-x-12 lg:space-x-20 lg:mx-20">
                <p className="text-base font-semibold text-[#7f7aff]">
                  <a
                    href="https://www.instagram.com/sean.donny/"
                    target="_blank"
                  >
                    Instagram
                  </a>
